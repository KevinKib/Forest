unit initialisationVariables_UNIT;
  { RÔLE :  Cette unité a pour rôle d'initialiser toutes les variables et types de variables
...
implementation
  ...
  procedure initialisationVariables(var game: TGame; var civ: TCivilisation; var combat: TCombat);
  {RÔLE ET PRINCIPE : Cette procédure initialise les différentes variables grâce à l'affectation Pascal}
  begin
